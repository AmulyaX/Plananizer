...
export default function DialogSelect() {
  ...
  function pushData(){
    var dt = []
    dt = {"id": state.date, "amt": state.totalSalary, "grocery": state.grocery, "emi":state.emi, "shopping": state.shopping, "personal": state.personal, "extraSavings": state.extraSavings}
  ...
  function handleCloseOk() {
    setState({ ...state, open: false });
    console.log(state.type, state.date, state.amt)
    pushData()
  }
  ...
  return (
    <div>
      <Button onClick={handleClickOpen}><Typography variant="h5" component="h2" gutterBottom='true'>Store Data for a particular <strong>Month</strong></Typography></Button>
            ...
            <Grid container spacing={32} alignItems="center" justify="center">
              <Grid item xs={12} md={6} lg={4}>
                <FormControl className={classes.formControl}>
                  <InputLabel htmlFor="type-native-simple">Date</InputLabel>
                  <DatePicker 
